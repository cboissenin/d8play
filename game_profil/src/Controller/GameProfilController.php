...
namespace Drupal\game_profil\Controller;
 ...
 */
class GameProfilController extends ControllerBase {
  /**
   * [page description]
...
//    $nodes = entity_load_multiple('node', $nids);
  ...
  public function edit() {
    $form = \Drupal::formBuilder()->getForm('Drupal\game_profil\Form\EditProfileForm');
