...
/**
 * @file
 * Contains \Drupal\content_entity_example\Entity\Controller\ContactListBuilder.
 */

namespace Drupal\entity_character\Entity\Controller;
 ...
 */
class CharacterListBuilder extends EntityListBuilder {
...
//    $header['gender'] = $this->t('Gender');
  ...
  public function buildRow(EntityInterface $entity) {
    /* @var $entity \Drupal\entity_character\Entity\Character */
    $row['id'] = $entity->id();
